...
class Model(tf.keras.Model):
    ...
    def __init__(self, units_size=512, init_noise_topics=0.05, init_noise_overshoot_topics=0.2,
        ...
        self.finalOvershoot = model_bert_submodels.FullyConnectedSubmodelMiniClass(units_size=128, name="overshoot_activation_final")
        ...
        self.final = model_bert_submodels.FullyConnectedSubmodelMiniClass(units_size=128, name="activation_final")
